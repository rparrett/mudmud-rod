local definitions = {
    ...
    { name = "quaffamt", kind = "number", usage = "<number>", description = "Estimated HP restored by one healing potion", minimum = 1 },
    { name = "equaffkw", kind = "string", usage = "<text|unset>", description = "Keyword for emergency healing potions" },
    { name = "equaffthresh", kind = "number", usage = "<number>", description = "Emergency quaff when this much HP is missing", minimum = 0 },
    ...
    { name = "truesight", kind = "boolean", usage = "<on|off>", description = "Maintain true sight and cure blindness" },
    { name = "truesightkw", kind = "string", usage = "<text|unset>", description = "Keyword for true-sight potions" },
    { name = "blindkw", kind = "string", usage = "<text|unset>", description = "Keyword for cure-blindness potions" },
    ...
    { name = "notifytells", kind = "boolean", usage = "<on|off>", description = "Send notifications for incoming tells" },
    { name = "notifyyells", kind = "boolean", usage = "<on|off>", description = "Send notifications for yells" },
    { name = "ntfyurl", kind = "string", usage = "<text|unset>", description = "ntfy.sh topic URL for chat notifications" },
